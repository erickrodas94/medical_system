                    ...
                    <div class="pt-5 border-t border-slate-100 grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div class="relative shadow-sm rounded-lg">
                                ...
                                <input type="number" step="0.01" name="consultation_price" placeholder="0.00" class="w-full px-4 py-2 pl-14 border border-slate-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 text-sm font-bold text-slate-700">
                            </div>
                            <p class="px-1 text-[11px] text-slate-400 mt-1"><?= __('consultation_fee_help') ?></p>
                        </div>
                    </div>
                </div>
